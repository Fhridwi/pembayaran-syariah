...
@section('content')
    <section class="section">
        <div class="alert alert-warning" role="alert">
            <strong>Info:</strong> Tagihan <strong>bulanan</strong> hanya dapat dibuat dalam <strong>3 hari
                terakhir</strong> bulan berjalan (misalnya tanggal 28, 29, atau 30/31).
        </div>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('tagihan-massal.store') }}">
                    ...
                    <div class="row mb-3">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                @foreach(['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember'] as $bln)
                                    <div class="form-check me-3">
                                        <input class="form-check-input" type="checkbox" id="bulan_{{ $bln }}" name="bulan[]"
                                            value="{{ $bln }}">
                        ...
                        <div class="mb-3 col-md-6" id="keterangan-bebas" style="display: none;">
                            <div class="col-md-12">
                                <label for="keterangan" class="form-label">Keterangan Tagihan</label>
                                <input type="text" name="keterangan" id="keterangan" class="form-control"
                                    placeholder="Contoh: Uang Pendaftaran Semester Genap">
                            </div>
                        </div>

                        <div class="row mb-3 col-md-3" id="jatuh-tipo-bebas" style="display: none;">
                            <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="nominal" name="nominal" class="form-control" placeholder="Rp" readonly
                            required>
                    </div>
    ...
    <script>
        function togglePeriodeFields() {
            ...
            document.getElementById('keterangan-bebas').style.display = periode === 'bebas' ? 'block' : 'none';
            document.getElementById('jatuh-tipo-bebas').style.display = periode === 'bebas' ? 'block' : 'none';
        }

        document.getElementById('periode').addEventListener('change', togglePeriodeFields);
        window.addEventListener('DOMContentLoaded', togglePeriodeFields);
